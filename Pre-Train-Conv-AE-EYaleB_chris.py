...
class ConvAE(object):
    def __init__(self, n_input, kernel_size,n_hidden, learning_rate = 1e-3, batch_size = 256,\
        reg = None, denoise = False,restore_path = None, logs_path = './logs'):# ,model_path = None,restore_path = None, logs_path = './logs'):
    ...
    def save_model(self,it):
        model_path = model_path = './pretrain-model-EYaleB/model-'+str(it)+'-48x42-yaleb.ckpt'
...
def train_face(Img, CAE, n_input, batch_size):
    it = 0
    display_step = 300 #print every 300 iterations
    save_step = 900
    _index_in_epoch = 0
    _epochs= 0
...
if __name__ == '__main__':
    ...
    #model_path = './pretrain-model-EYaleB/model-'+str(it)+'-48x42-yaleb.ckpt'
    ...
    CAE = ConvAE(n_input = n_input, n_hidden = n_hidden, learning_rate = lr, kernel_size = kernel_size,
                 batch_size = batch_size, restore_path = restore_path)#, model_path = model_path, restore_path = model_path)
